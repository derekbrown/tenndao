      ...
      <div className="flex w-full items-center mt-12">
        <div className="w-full sm:w-2/3">
          <div className="text-3xl sm:text-4xl text-neutral-gray2 mb-8">
            ...
            <div className="text-lg mt-4 text-neutral-gray3">If you believe in delivering web3's promises of <span className="font-semibold text-neutral-gray2">ownership</span> and <span className="font-semibold text-neutral-gray2">freedom</span> to the next 100 million users, we’d love to talk to you!</div>
          </div>
