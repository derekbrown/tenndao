      ...
      <div className="flex w-full items-center mt-12">
        <div className="w-full sm:w-2/3">
          <div className="text-3xl sm:text-4xl text-neutral-gray2 mb-8">
            ...
            <div className="text-lg mt-4 text-neutral-gray3">Bunches is a mobile-first <strong className="font-semibold">web3 messenger</strong> with an integrated social wallet, designed specifically for creators and their communities.</div>
